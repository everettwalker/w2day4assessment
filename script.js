...
function addNums(){
    // Your answer here:
      ...
      for (var i=0; i<numbers.length; i++){addNums+=numbers [i]};
      return numbers;
...
function addActor(){
    // Your answer here:
    addActor.push (Yukiko Shimazaki)
   return "film";
 }
...
function getLosses(){
    // Your answer here:
    // note:budge minus property is negative number; not understanding this one//
...
function interleave(){
    ...
    // Your answer here:
     let (interleave)="vals";
     interleave()=numberVals.concat(letterVals);
     return "vals";
